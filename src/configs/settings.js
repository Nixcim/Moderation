 ...
 */
 ...
 module.exports = (client) => {
    ...
    client.settings = {
        ...
        Prefix: ".",
        Token: "OTI4MjQ1NTg3NjUwOTY1NjI0.YdV-Eg.trDOC-_2vogsggRch5e6Ho5Onuk",
        Owners: [920042680942231593],
        OtherBots: [928375456913309747],
        VoiceChannel: "928375457521491992",
        Activity: "LISTENING",
        Status: "dnd",
        MongoURL: "mongodb+srv://Mikey:wer34al38@cluster0.sioaz.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
        Footer: "Mikey. 💜 Revolia",
